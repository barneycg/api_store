...
$sql = "SELECT a.users_id as users_id,a.key_uid as key_uid,a.api_key as api_key, u.ignore_err as ignore_err, u.wiki as wiki FROM api_keys as a,users as u where a.users_id = u.id and (a.valid = 'invalid' OR a.valid = 'old')";
