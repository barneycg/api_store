...
function displayUsers(){
   global $database;
   $q = "SELECT username,userlevel,email,forum_name,timestamp "
   ...
   echo "<tr><td><b>Username</b></td><td><b>Forum Name</b></td><td><b>Level</b></td><td><b>Email</b></td><td><b>Last Active</b></td></tr>\n";
   for($i=0; $i<$num_rows; $i++){
      ...
      echo "<tr><td>$uname</td><td>$forum_name</td><td>$ulevel</td><td>$email</td><td>$time</td></tr>\n";
   }
   echo "</table><br>\n";
}
...
<option value="2">Former Member
<option value="3">To Remove
<option value="4">In Corp
<option value="6">Dummy
<option value="5">Recruiter
