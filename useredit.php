...
<td>Forum Name:</td>
<td><input type="text" name="forum_name" maxlength="50" value="<?
if($form->value("forum_name") == ""){
   echo $session->userinfo['forum_name'];
}else{
   echo $form->value("forum_name");
}
?>">
</td>
<td><? echo $form->error("forum_name"); ?></td>
</tr>
...
<tr><td>Back to [<a href="index.php">Main</a>]</td></tr>
</table>
</form>
